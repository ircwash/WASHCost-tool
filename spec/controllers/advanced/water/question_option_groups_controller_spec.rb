...
describe Advanced::Water::QuestionOptionGroupsController do
  ...
  # Advanced::Water::QuestionOptionGroup. As you add validations to Advanced::Water::QuestionOptionGroup, be sure to
  # adjust the attributes here as well.
  let(:valid_attributes) { { "name" => "MyString" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # Advanced::Water::QuestionOptionGroupsController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested advanced_water" do
        question_option_group = Advanced::Water::QuestionOptionGroup.create! valid_attributes
        # Assuming there are no other advanced_water_question_option_groups in the database, this
        # specifies that the Advanced::Water::QuestionOptionGroup created on the previous line
  ...
  describe "DELETE destroy" do
    it "destroys the requested advanced_water" do
      question_option_group = Advanced::Water::QuestionOptionGroup.create! valid_attributes
      expect {
        delete :destroy, {:id => question_option_group.to_param}, valid_session
      }.to change(Advanced::Water::QuestionOptionGroup, :count).by(-1)
    end

    it "redirects to the advanced_water_question_option_groups list" do
      question_option_group = Advanced::Water::QuestionOptionGroup.create! valid_attributes
      delete :destroy, {:id => question_option_group.to_param}, valid_session
      response.should redirect_to(advanced_water_question_option_groups_url)
    end
  end
